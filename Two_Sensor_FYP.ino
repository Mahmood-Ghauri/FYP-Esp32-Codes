...
unsigned long timerDelay = 3000;  // Send data every 5 second
...
void loop() {
  ...
  if ((millis() - lastTime) > timerDelay) {
    ...
    String path = "/sensorData/" + String(i); // Timestamp as key
    FirebaseJson json;
    ...
    json.set("/Total_Current",L_current);
    ...
    json.set("/Total_Act_Power",L_act_power);
    ...
    json.set("/Total_ReAct_Power",L_react_power);
    ...
    json.set("/Total_App_Power",L_app_power);
